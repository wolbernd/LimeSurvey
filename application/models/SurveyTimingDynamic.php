...
class SurveyTimingDynamic extends LSActiveRecord
{
    ...
    public function getButtons()
    {
        ...
        if (Permission::model()->hasSurveyPermission(self::$sid, 'responses', 'delete')) {
            ...
            $buttons .= '<a class="btn btn-sm btn-default" data-target="#confirmation-modal" data-href="' . $deleteUrl . '" role="button" data-toggle="modal" data-tooltip="true" title="' . gT('Delete this response') . '"><span class="text-danger fa fa-trash" ></span></a>';
        }
        $buttons .= '</div>';
        return $buttons;
    }
