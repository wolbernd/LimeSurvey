 ...
 * @property string $surveyls_policy_error The survey data-security custom error message
 * @property string $surveyls_policy_notice_label The survey data-security notice label
 * @property string $surveyls_legal_notice The legal notice message
