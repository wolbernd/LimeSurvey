            ...
            ajax.methods.$_get(
                ...
                .then(
                    (result) => {
                        ...
                        context.commit('setLegalNoticeMessage', result.data.textdata.legalnoticemessage);
                        context.commit('setShowDataSecurityButton', result.data.showdatasecuritybutton);
                        context.commit('setShowLegalNoticeButton', result.data.showlegalnoticebutton);
    ...
    saveData: (context) => {
        ...
        let transferObject = _.merge({
            'changes': {
                ...
                legalnoticemessage: context.state.legalnoticemessage,
                showdatasecuritybutton: context.state.showdatasecuritybutton ? 1 : 0,
                showlegalnoticebutton: context.state.showlegalnoticebutton ? 1 : 0,
            }
